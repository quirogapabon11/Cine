    ...
    public partial class Presentacion : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CadenaCine", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Contrasena = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    CadenaCineId = table.Column<Guid>(type: "char(36)", nullable: true, collation: "ascii_general_ci"),
                    SistemaId = table.Column<Guid>(type: "char(36)", nullable: true, collation: "ascii_general_ci")
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Miembro_CadenaCine_CadenaCineId",
                        column: x => x.CadenaCineId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Sede_CadenaCine_CadenaCineId",
                        column: x => x.CadenaCineId,
                        principalTable: "CadenaCine",
                        principalColumn: "Id");
                })
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Invitado_Miembro_MiembroId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Pelicula = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    IdSala = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci"),
                    IdCine = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci"),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Invitado_MiembroId",
                table: "Invitado",
                column: "MiembroId");

            migrationBuilder.CreateIndex(
                name: "IX_Miembro_CadenaCineId",
                table: "Miembro",
                column: "CadenaCineId");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Administrador_Miembro_Id",
                table: "Administrador",
                column: "Id",
                principalTable: "Miembro",
                principalColumn: "Id",
